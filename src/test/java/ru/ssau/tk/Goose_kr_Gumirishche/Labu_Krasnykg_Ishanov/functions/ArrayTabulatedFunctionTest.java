...
public class ArrayTabulatedFunctionTest {
    ...
    private final AbstractTabulatedFunction arrayTabulatedFunction1 = new ArrayTabulatedFunction(xValues1, yValues1);
    private final AbstractTabulatedFunction arrayTabulatedFunction2 = new ArrayTabulatedFunction(xValues2, yValues2);
    private final CompositeFunction compositeFunction = new CompositeFunction(new SumFunction(), new SqrFunction());
    private final AbstractTabulatedFunction arrayTabulatedFunction3 = new ArrayTabulatedFunction(compositeFunction, -3, 3, 7);
